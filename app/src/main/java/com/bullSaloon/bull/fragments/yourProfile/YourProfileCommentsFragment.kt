...
import com.bullSaloon.bull.databinding.FragmentYourProfileCommentsBinding


class YourProfileCommentsFragment : Fragment() {

    private var _binding: FragmentYourProfileCommentsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentYourProfileCommentsBinding.inflate(inflater,container,false)
        return binding.root
    }
}